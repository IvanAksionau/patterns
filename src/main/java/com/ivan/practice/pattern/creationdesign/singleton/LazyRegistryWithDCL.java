 ...
 *
 * (DCL) attempts to improve performance of lazy instantiation but without memory barriers is exposed to dangerous race
 * conditions between the setting of a variable's address and the publishing of its value to main memory.
 */
